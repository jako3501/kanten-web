<template>
    <div class="container">
        <img src="../assets/img/Platformen_09.jpg" alt="">
        <img src="../assets/img/Platformen_10.jpg" alt="">
        <img src="../assets/img/Platformen_11.jpg" alt="">
        <img src="../assets/img/Platformen_12.jpg" alt="">
        <h1>Kraftværket</h1>
        <p>Esbjerg har i flere år manglet gængse øvelokaler med mulighed for indspilning, og her vil Kanten give muligheden
            for at benytte sig af et lydstudie samt et øvelokale af høj kvalitet. I kraft af Kantens vision om at hjælpe det
            musikalske vækstlag med at skabe musik, så vil der tilbydes en lydtekniker som ifølge aftale kan undervise i
            lydstudieteknik - alt efter behov. Med Kraftværkets placering i Østerbyen vil vi løfte interessen for musik,
            særligt for de lokale unge. Det vil vi f.eks. gøre med undervisning i øjenhøjde og med kendskab til unge i
            området. Kraftværket kan benyttes af alle der spiller, eller gerne vil spille musik.</p>
    </div>
